 ...
 * Description: Lightweight WhatsApp click-to-chat button with working hours, page visibility controls, and smart country selector. GDPR-friendly with no tracking.
 * Version: 1.0.0
 * Author: iruserwp9
